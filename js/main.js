...
// Create new wheel object specifying the parameters at creation time.
            var theWheel = new Winwheel({
                ...
                [                               // font size and test colour overridden on backrupt segments.
                   {'fillStyle' : '#5ee9e1', 'text' : 'A'},
                   {'fillStyle' : '#f3f3f3', 'text' : 'B'},
                   {'fillStyle' : '#a8f8cc', 'text' : 'C'},
                   {'fillStyle' : '#CC009A', 'text' : 'D'}
                ],
            ...
            function stopSpin()
            {
              	theWheel.animation = {
                    ...
                    'stopAngle': getRandomGrade(360),
		            'easing'   : Sine.easeOut, //'Linear.easeNone',
            ...
            function alertPrize()
            {
                //Check how many times the wheel rotates
                if(times<=10 && counter>5){
                    alert(100*counter);
                }
